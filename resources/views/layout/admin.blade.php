    ...
    <div class="sidebar ">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="pages/widgets.html" class="nav-link {{request()->is('datapasien') ? 'active' : ''}}">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link {{request()->is('dataaturan') ? 'active' : ''}}">
              <i class="nav-icon fas fa-edit"></i>
              <p> Data Aturan </p>
            </a>
          </li>
          <li class="nav-item">
            <a href="#" class="nav-link {{request()->is('datatreatment') ? 'active' : ''}}">
...
<script src="{{ asset('template/dist/js/demo.js')}}dist/js/demo.js"></script>
