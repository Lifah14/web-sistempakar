          ...
          @csrf
            <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" id="kode_gejala" name="kode_gejala" class="form-control" value="{{ old('kodegejala', '') }}" placeholder="G04">
                </div>
                <div class="form-group">
                  <label for="nama">Nama Gejala</label>
                  <input type="text" id="nama" name="nama_gejala" class="form-control" value="{{ old('nama', '') }}" placeholder="text">
                </div>
            </div>
